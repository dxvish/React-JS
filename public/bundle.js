...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Greeter = React.createClass({
		...
		handleNewName: function handleNewName(name, body) {
			this.setState({
				name: name,
				body: body
			});
		...
		render: function render() {
			...
			return React.createElement(
				'div',
				null,
				React.createElement(GreeterMessage, { name: name, body: body }),
	...
	var GreeterForm = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement("input", { type: "text", ref: "name", placeholder: "Enter the Name" }),
				React.createElement("br", null),
				React.createElement("textarea", { ref: "body", placeholder: "Enter the Description" }),
				React.createElement(
					"button",
					null,
					"Show Names"
